            ...
            <fieldset>
              ...
              <table class="table table-striped table-hover ">
                ...
                <tbody>
			    	...
			    	List<Comodo>salas = (List<Comodo>)request.getAttribute("salas");
			    	for(Comodo c : salas){
			    		out.println("<tr><td>");
			    		out.print(c.getDescricao());
			    		out.print("<td><ul class = 'breadcrumb'><li><a href='EditarSala?id="+c.getIdComodo()+"&&descricao="+c.getDescricao()+"'>Editar</a></li><li><a href='DeletarSala?id="+c.getIdComodo()+"'>Deletar</a></li></ul></td>");
			    		out.println("</td></tr>");
			    	}
			    	%>
                </tbody>
