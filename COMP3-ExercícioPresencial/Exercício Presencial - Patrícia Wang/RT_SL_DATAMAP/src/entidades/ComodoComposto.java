...
public class ComodoComposto extends Comodo{
	...
	public Map<Integer,String> listaMobiliaDisponivel() {
		...
		Map<Integer, String> mapMobilia = mobiliaMapper.listarMobiliasDisponiveisTotal(TipoComodo.COMODO_COMPOSTO.toString());
	...
	public static List<Mobilia> listarMobilias(int id){
		...
		mob.addAll(mapperMobilia.listarMobiliasPorComodo(id));
		return mob;
	}
