...
<html lang="en">
  <head>
    <meta charset="utf-8">
    <title>Editar Cômodo Composto</title>
    ...
    <div class="container">
        <div class="row">
          <div class="col-md-6 col-md-offset-3">    
            <div class="well">
              <form class="form-signin" method='post' action='EditarComodoComposto'>
                <fieldset>
                  <legend>Editar Cômodo Composto</legend>
                  <div class="form-group">
                    	...
                    	<div class="col-lg-10">
                    		<% String desc = request.getParameter("descricao");%>
                      		...
                      		<% String idComposto = request.getParameter("id");
                    	    out.println("<input type='hidden' name='id' value = '"+idComposto+"'>");
                    		//System.out.println("id " + idComposto);%>
                    	</div>
                  </div>
					<div class="form-group">
					      ...
					      <div class="col-lg-10">
					        <select multiple="" class="form-control" name = "comodoSelect">
					          ...
					          List<Comodo>listaComodo = comodoMapper.listarComodoTotal();
					          
					          for(Comodo c : listaComodo){
					        	  
					        	  int id = Integer.parseInt(idComposto);
					        	  
					        	  if(c.getTipoComodo().equals(TipoComodo.COMODO_COMPOSTO.toString()) && c.getIdComodo() == id){
					        		  listaComodo.remove(c);
					        		  break;
					        	  }
					          }
