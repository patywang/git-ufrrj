            ...
            <fieldset>
              ...
              <table class="table table-striped table-hover ">
                ...
                <tbody>
			    	...
			    	List<Comodo>quartos = (List<Comodo>)request.getAttribute("quartos");
			    	for(Comodo c : quartos){
			    		out.println("<tr><td>");
			    		out.print(c.getDescricao());
			    		//System.out.println(c.getDescricao());
			    		out.print("<td><ul class = 'breadcrumb'><li><a href='EditarQuarto?id="+c.getIdComodo()+"&&descricao="+c.getDescricao()+"'>Editar</a></li><li><a href='DeletarQuarto?id="+c.getIdComodo()+"'>Deletar</a></li></ul></td>");
			    		out.println("</td></tr>");
			    	}
			    	%>
                </tbody>
