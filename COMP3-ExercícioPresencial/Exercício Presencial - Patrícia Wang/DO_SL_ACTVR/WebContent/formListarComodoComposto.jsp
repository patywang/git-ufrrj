...
<html lang="en">
  <head>
    <meta charset="utf-8">
    <title>Listar Cômodo Composto</title>
  ...
  <body>
    ...
    <div class="container">
        ...
        <div class="row">
          <div class="col-lg-12">
            <fieldset>
                  <legend>Listar Cômodo Composto</legend>
              <table class="table table-striped table-hover ">
                ...
                <tbody>
			    	...
			    	List<Comodo>comodoComposto = (List)request.getAttribute("comodosCompostos");
			    	for(Comodo c : comodoComposto){
			    		out.println("<tr><td>");
			    		out.print(c.getDescricao());
			    		out.print("<td><ul class = 'breadcrumb'><li><a href='EditarComodoComposto?id="+c.getIdComodo()+"&&descricao="+c.getDescricao()+"'>Editar</a></li></ul></td>");
			    		out.println("</td></tr>");
			    	}
			    	%>
                </tbody>
