    ...
    <div class="container">
        <div class="row">
          <div class="col-md-6 col-md-offset-3">    
            <div class="well">
              <form class="form-signin" method='post' action='EditarCozinha'>
                <fieldset>
                  <legend>Editar Cozinha</legend>
                  <div class="form-group">
                    ...
                    <div class="col-lg-10">
                      ...
                      <input type="text" name="novaDescricao" class="form-control" id="inputDescricao" value = '<%= desc %>'>
                    	...
                    	String idpai = request.getParameter("idpai"); //não usado mais
                    	out.println("<input type='hidden' name='idpai' value = '"+idpai+"'>"); // não usado mais
                    	%>
                    </div>
                  </div> 
                  <div class="form-group">
